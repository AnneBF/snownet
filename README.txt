...
Since July the new version of 'SNOWNET_sample_code.py' also includes an uncertainty estimation.
...
Satellite Microwave Radiometry and a Neural Network, The Cryosphere, (2019)'
